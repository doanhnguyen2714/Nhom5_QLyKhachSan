...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="<?php echo SROOT."/admin/index.php"; ?>"><img src="<?php echo SROOT."/public/media/images/logo/fefe_logo.png";?>" class="d-inline-block align-top" height="90px"></img></a>
    <button
